...
from lib.myweight import myWeight
#        MainWindow.resize(314, 462)
#background-color: rgb(0, 0, 0);
class Ui_MainWindow(object):

    def setupUi(self, MainWindow):
        MainWindow.setObjectName("QiBao")

        MainWindow.resize(628, 462)
        ...
        # self.textEdit.setText("<font color=%s>%s</font>" %('#F8F8FF', "一个python小白进阶之路"))
    ...
    #     self.centralwidget.setGeometry(300, 300, 300, 220)
    #     self.centralwidget.self.setWindowTitle('Icon')
    #     self.centralwidget.setWindowIcon(QIcon('./icon/bg.png'))        
    #     self.show()
